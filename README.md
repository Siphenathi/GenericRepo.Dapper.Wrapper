...
---
## Introduction
> This [Dapper](https://github.com/StackExchange/Dapper) extension allows you to fluently configure the mapping between model properties and database columns. 
